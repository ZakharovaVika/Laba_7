...
В программе должны быть реализованы минимум один класс, три атрибута, два метода.""""""Ограничение: максимальная сумма элементов массива не должна превышать некоторое число .
